...
<footer class="p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800">
  <div class="mx-auto max-w-screen-xl text-center">
      <a href="#" class="flex justify-center items-center text-2xl font-semibold text-gray-900 dark:text-white">
          ...
          Đọc các chap raw mới nhất với sự giúp đỡ của AI    
      </a>
      <p class="my-6 text-gray-500 dark:text-gray-400">Dưới đây là một số web truyện tranh Trung Quốc bạn có thể dùng để lấy link chapter cần dịch: </p>
      <ul class="flex flex-wrap justify-center items-center mb-6 text-gray-900 dark:text-white">
        <li>
            <a href="https://www.baozimh.com/" class="mr-4 hover:underline md:mr-6" target="_blank">Baozimh</a>
        </li>
        <li>
            <a href="https://manga.bilibili.com/" class="mr-4 hover:underline md:mr-6" target="_blank">Bilibili Comics</a>
        </li>
        <li>
          <a href="https://ac.qq.com/" class="mr-4 hover:underline md:mr-6 " target="_blank">Tencent Comics</a>
        </li>
      ...
      <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 02/09/2024 <a href="#" class="hover:underline">BlueChapter™</a>. Địa chỉ liên hệ: cuongtk2002@gmail.com.</span>
  </div>
</footer>
  );
}
